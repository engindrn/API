...
public class Get12Pojo extends RestfulBaseUrl {
    ...
    */
    ...
    public void get12Pojo(){
        ...
        //Set the Expected Data                                              //obje olustururken parametreli cons. yapariz aksi halde hepsi null degerler doner
        BookingDatesPojo bookingDatesPojo = new BookingDatesPojo("2018-01-01","2019-01-01");
        BookingPojo expectedData = new BookingPojo("Guoqiang","Liu",111,true,bookingDatesPojo,"Breakfast");
        System.out.println("expectedData = " + expectedData);                                                 //bi ustteki parametreli
