...
public class Get05b extends ReqresBaseUrl {
    ...
    public void test01() {
       ...
       // response.prettyPrint();
        ...
        JsonPath jsonPath = response.jsonPath();            //datalara ulasmak  disari almak icin kullandik
        jsonPath.prettyPrint();                            //badyde data icindeki butun degerlere ulasmistik
                                                         //getInt() integer datalara getString() string datalara ulasmamizi saglar
